...
app.use(
    session({
        ...
        store: MongoStore.create({
            mongoUrl:'mongodb+srv://gauna_mario:D8GuMWgPoTICAKPv@cluster0.1vxmmjy.mongodb.net/desafio12?retryWrites=true&w=majority'}),
            options: {
...
app.get('/productos',async(req,res)=>{
    ...
    if(persona){
        if (products != null){
            res.render('index.ejs',{products,persona})
        } else {
            products = [];
            res.render('index.ejs',{products,persona})
        }
